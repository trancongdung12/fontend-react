        ...
        return ( <
            ...
            div class = "cart-info" > {
                this.state.carts.map((item, key) => (
                    ...
                    <
                    span onClick = { this.onRemoveCart(key) }
                    ...
                    /div> <
                    p class = "cart-price" > < NumberFormat value = { item.price }
                    displayType = { 'text' }
                    ...
                    hidden / >
                    <
                    p class = "cart-price" > < NumberFormat value = { item.price * item.quantity }
                    displayType = { 'text' }
                    thousandSeparator = { true }
                    /> đ</p >
                    <
            ...
            <
            b > Tổng tiền: < NumberFormat value = { total }
            displayType = { 'text' }
            thousandSeparator = { true }
            /> đ</b >
            <
