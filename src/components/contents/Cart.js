            ...
            <div class="shopping-cart">
                <div class="cart-info">
                    {this.state.carts.map((item,key)=>(
                        ...
                        <p class="cart-price"><NumberFormat value={item.price} displayType={'text'} thousandSeparator={true} /> đ</p>
                ...
                <div class="cart-total">
                    <b>Tổng tiền: <NumberFormat value={total} displayType={'text'} thousandSeparator={true} /> đ</b>
                </div>
                <hr/>
